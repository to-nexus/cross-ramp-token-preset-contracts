...
import {ERC1155Upgradeable} from "@openzeppelin-contracts-upgradeable-5.4.0/token/ERC1155/ERC1155Upgradeable.sol";
import {ERC1155HolderUpgradeable} from
    "@openzeppelin-contracts-upgradeable-5.4.0/token/ERC1155/utils/ERC1155HolderUpgradeable.sol";
...
abstract contract ERC1155Base is TokenBase, IERC1155Forge, ERC1155Upgradeable, ERC1155HolderUpgradeable {
    function initialize(address owner, address manager, string memory baseTokenURI, bytes memory) external virtual;

    function __ERC1155Base_init(address owner, address manager, string memory baseTokenURI) internal onlyInitializing {
